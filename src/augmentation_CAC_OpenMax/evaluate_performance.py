...
from src.augmentation_CAC_OpenMax.train_augmentated_CAC import train_augmentated_cac_classifier
...
if __name__ == "__main__":
    ...
    for seed in SEEDS:
        ...
        # === 训练 ===
        model = train_augmentated_cac_classifier(
