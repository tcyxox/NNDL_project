...
|-------------|------------------|-----------------|----------------|----------------|
| 0.1         | 68.19% ± 0.58%   | 94.51% ± 0.18%  | 45.75% ± 1.02% | 0.8646 ± 0.0007|
| 0           | 72.00% ± 0.51%   | 95.10% ± 0.12%  | 52.31% ± 0.96% | 0.8908 ± 0.0009|
...
|--------------|------------------|-----------------|-----------------|----------------|
| 2            | 71.75% ± 0.21%   | 94.55% ± 0.29%  | 52.31% ± 0.44%  | 0.8844 ± 0.0014|
| 4            | 71.57% ± 0.76%   | 94.75% ± 0.31%  | 51.81% ± 1.53%  | 0.8850 ± 0.0022|
| 8            | 71.23% ± 0.83%   | 94.67% ± 0.23%  | 51.24% ± 1.49%  | 0.8872 ± 0.0014|
...
| 10        | 0.1      | -1           | 3             | 10                | 83.72% ± 0.16%     | 74.12% ± 0.21%  | 91.91% ± 0.13%  | 0.9014 ± 0.0023 |
| 10        | 0.1      | -1           | 3             | 3                 | 86.35% ± 0.14%     | 89.61% ± 0.45%  | 83.58% ± 0.44%  | 0.9355 ± 0.0011 |
...
相比于仅使用OpenMax需要更小的tail_size: CAC能够聚拢类别，不会有太多长尾分布


## v1.2 CAC + OpenMax + cosine
``` py
class ExperimentConfig:
    # 训练参数
    batch_size: int = 64
    ...
    distance_type
```
| alpha_CAC | lambda_w | se_reduction | alpha_OpenMax | weibull_tail_size | anchor_mode         | distance_type | Subclass Overall   | Subclass Seen   | Subclass Unseen | Subclass AUROC  | 
|-----------|----------|--------------|---------------|-------------------|---------------------|---------------|--------------------|-----------------|-----------------|-----------------|
| 10        | 0        | -1           | 3             | 5                 | axis_aligned        | cosine        | 84.95% ± 0.64%     | 81.10% ± 1.59%  | 88.23% ± 2.08%  | 0.9113 ± 0.0054 |
| 10        | 0        | -1           | 3             | 5                 | negative_shattered  | cosine        | 85.32% ± 0.34%     | 81.45% ± 0.79%  | 88.63% ± 1.10%  | 0.9089 ± 0.0044 |
| 20        | 0        | -1           | 3             | 5                 | negative_shattered  | cosine        | 83.95% ± 0.30%     | 84.04% ± 1.04%  | 83.88% ± 1.29%  | 0.9042 ± 0.0083 |
...
class ExperimentConfig:
    ...
    anchor_mode = "axis_aligned"
```
| alpha | lambda_w | lambda_open | Subclass Overall | Subclass Seen   | Subclass Unseen  | Subclass AUROC   | 
|-------|----------|-------------|------------------|-----------------|------------------|------------------|
| 10    | 0        | 0.2         | 71.97% ± 1.33%   | 93.33% ± 0.28%  | 53.75% ± 2.32%   | 0.8981 ± 0.0024  |
| 10    | 0        | 0.3         | 72.13% ± 1.38%   | 93.06% ± 0.56%  | 54.28% ± 2.32%   | 0.9003 ± 0.0015  |
| 10    | 0        | 0.5         | 70.78% ± 1.49%   | 91.41% ± 0.66%  | 53.18% ± 2.69%   | 0.8986 ± 0.0024  |


## CAC + OpenMax + OpenMix

| alpha_CAC | lambda_w | lambda_open | alpha_OpenMax | weibull_tail_size | Subclass Overall   | Subclass Seen   | Subclass Unseen | Subclass AUROC  | 
|-----------|----------|-------------|---------------|-------------------|--------------------|-----------------|-----------------|-----------------|
| 10        | 0        | 0.3         | 3             | 3                 | 78.00% ± 0.24%     | 88.24% ± 0.33%  | 69.26% ± 0.42%  | 0.8674 ± 0.0025 |

新划分 + se_reduction=4
[Subclass] Overall            : 84.28% ± 0.85%
[Subclass] Seen               : 94.63% ± 0.40%
[Subclass] Unseen             : 75.45% ± 1.53%
AUROC                         : 0.9411 ± 0.0021

新划分 + se_reduction=-1
[Subclass] Overall            : 71.64% ± 0.49%
[Subclass] Seen               : 92.94% ± 0.12%
[Subclass] Unseen             : 53.48% ± 0.88%
AUROC                         : 0.8978 ± 0.0025