...
\begin{itemize}
    ...
    \item Select a \textbf{soft constraint method} used in training (e.g., Channel-Wise Attention), select a \textbf{hard constraint method} used in inference (Masking strategy).
